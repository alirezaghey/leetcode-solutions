...
| 20   | [Valid Parentheses](https://leetcode.com/problems/valid-parentheses/)                                                     | <ul><li>[PY](python/valid-parentheses.py)</li><li>[JS](js/valid-parentheses.js)</li><li>[Go](go/valid_parentheses.go)</li></ul>                                           |     _O(n)_      |    _O(n)_    | String, Stack                                  |
...
| 3    | [Longest Substring without Repeating Chars](https://leetcode.com/problems/longest-substring-without-repeating-characters/)                        | <ul><li>[PY](python/longest-substring-without-repeating-chars.py)</li><li>[JS](js/longest-substring-without-repeating-chars.js)</li><li>[Go](go/longest_substring_without_repeating_chars.go)</li></ul>                                           |        _O(n)_        |   _O(min(n,m))_    | Hash Table, Two Pointers, String, Sliding Window |
| 8    | [String to Integer (atoi)](https://leetcode.com/problems/string-to-integer-atoi/)                                                                 | <ul><li>[JS](js/string-to-integer-atoi.js)</li><li>[PY](py/../python/string-to-integer-atoi.py)</li><li>[Go](go/string_to_integer_atoi.go)</li></ul>                                                                                              |        _O(n)_        |       _O(1)_       | Math, String                                     |
...
| 19   | [Remove Nth Node from End of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list/)                                               | <ul><li>[PY](python/remove-nth-node-from-end-of-list.py)</li><li>[JS](js/remove-nth-node-from-end-of-list.js)</li><li>[Go](go/remove_nth_node_from_end_of_list.go)</li></ul>                                                                      |        _O(n)_        |       _O(1)_       | Linked List, Two Pointers                        |
...
| 34   | [Find First and Last Position of Element in Sorted Array](https://leetcode.com/problems/find-first-and-last-position-of-element-in-sorted-array/) | <ul><li>[PY](python/find-first-and-last-position-of-element-in-sorted-array.py)</li><li>[JS](js/find-first-and-last-position-of-element-in-sorted-array.js)</li><li>[Go](go/find_first_and_last_position_of_element_in_sorted_array.go)</li></ul> |      _O(log n)_      |        O(1)        | Array, Binary Search                             |
| 36   | [Valid Sudoku](https://leetcode.com/problems/valid-sudoku/)                                                                                       | [JS](js/valid-sudoku.js)                                                                                                                                                                                                                          |        _O(1)_        |       _O(1)_       | Hash Table                                       |
| 48   | [Rotate Image](https://leetcode.com/problems/rotate-image/)                                                                                       | <ul><li>[PY](python/rotate-image.py)</li><li>[JS](js/rotate-image.js)</li></ul>                                                                                                                                                                   |        _O(n)_        |       _O(1)_       | Array                                            |
| 54   | [Spiral Matrix](https://leetcode.com/problems/spiral-matrix/)                                                                                     | <ul><li>[PY](python/spiral-matrix.py)</li><li>[JS](js/spiral-matrix.js)</li></ul>                                                                                                                                                                 |        _O(n)_        |       _O(n)_       | Array                                            |
| 59   | [Spiral Matrix II](https://leetcode.com/problems/spiral-matrix-ii/)                                                                               | <ul><li>[PY](python/spiral-matrix-ii.py)</li><li>[JS](js/spiral-matrix-ii.js)</li></ul>                                                                                                                                                           |        _O(n)_        |       _O(n)_       | Array                                            |
| 64   | [Minimum Path Sum](https://leetcode.com/problems/minimum-path-sum/)                                                                               | <ul><li>[PY](python/minimum-path-sum.py)</li><li>[JS](js/minimum-path-sum.js)</li></ul>                                                                                                                                                           |        _O(n)_        |       _O(1)_       | Array, Dynamic Programming                       |
| 74   | [Search a 2D Matrix](https://leetcode.com/problems/search-a-2d-matrix/)                                                                           | <ul><li>[PY](python/search-a-2d-matrix.py)</li><li>[JS](js/search-a-2d-matrix.js)  </li><li>[Go](go/search_a_2d_matrix.go)</li></ul>                                                                                                              | _O(log(m) + log(n))_ |       _O(1)_       | Array, Binary Search                             |
| 75   | [Sort Colors](https://leetcode.com/problems/sort-colors/)                                                                                         | <ul><li>[PY](python/sort-colors.py)</li><li>[JS](js/sort-colors.js)</li></ul>                                                                                                                                                                     |        _O(n)_        |       _O(1)_       | Array, Two Pointers, Sort                        |
...
| 120  | [Triangle](https://leetcode.com/problems/triangle/)                                                                                               | <ul><li>[PY](python/triangle.py)</li><li>[JS](js/triangle.js)</li></ul>                                                                                                                                                                           |        _O(n)_        |     _O(log n)_     | Array, Dynamic Programming                       |
...
| 438  | [Find All Anagrams](https://leetcode.com/problems/find-all-anagrams-in-a-string/)                                                                 | <ul><li>[PY](python/find-all-anagrams-in-a-string.py)</li><li>[JS](js/find-all-anagrams-in-a-string.js)</li></ul>                                                                                                                                 |        _O(n)_        |       _O(1)_       | Hash Table, Sliding Window, Two Pointers         |
...
| 508  | [Most Frequent Subtree Sum](https://leetcode.com/problems/most-frequent-subtree-sum/)                                                             | <ul><li>[PY](python/most-frequent-subtree-sum.py)</li><li>[JS](js/most-frequent-subtree-sum.js)</li></ul>                                                                                                                                         |        _O(n)_        |       _O(n)_       | Hash Table, Tree, DFS                            |
| 567  | [Permutation in String](https://leetcode.com/problems/permutation-in-string/)                                                                     | <ul><li>[PY](python/permutation-in-string.py)</li><li>[JS](js/permutation-in-string.js)</li><li>[Go](go/permutation_in_string.go)</li></ul>                                                                                                       |        _O(n)_        |       _O(1)_       | Two Pointers, Sliding Window, Hash Table         |
...
| 988  | [Smallest String Starting from Leaf](https://leetcode.com/problems/smallest-string-starting-from-leaf/)                                           | <ul><li>[PY](python/smallest-string-starting-from-leaf.py)</li><li>[JS](js/smallest-string-starting-from-leaf.js)</li><li>[Go](go/smallest_string_starting_from_leaf.go)</li></ul>                                                                |    _O(n * log n)_    |       _O(n)_       | Tree, DFS                                        |
...
[python solution](python/sum-of-left-leaves.py)
...
### 441. Arranging Coins
[python solution](python/arranging-coins.py)
