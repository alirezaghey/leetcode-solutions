...
/*
Initial thoughts:
We are going to loop over every linked list and check which of them
...
Space complexity: O(k) where k === the number of linked lists because we are going to hold the pointer to the beginning of each
